...
function LaunchErrorDialog({ message, onConfirm }: LaunchErrorDialogProps) {
  ...
  return (
    <div className="fixed inset-0 z-[95] flex items-center justify-center bg-[var(--bg-primary)]/82 p-6">
      <Card variant="frost" className="w-full max-w-lg rounded-[10px] p-6" interactive={false}>
        ...
        <div className="mt-4 rounded-[8px] border border-[#ff6b8f]/25 bg-[#ff6b8f]/10 px-4 py-3">
