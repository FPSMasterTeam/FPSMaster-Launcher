...
const translations = {
  "en-US": {
    ...
    "content.modrinthOnlyNotice": "Results are matched to your game version and loader for a safer install experience.",
  ...
  "zh-CN": {
    ...
    "content.modrinthOnlyNotice": "结果会根据当前游戏版本与加载器自动过滤，安装更省心。",
